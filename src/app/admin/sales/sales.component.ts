...
import { SaleItemsModel } from './../../shared/models/sale-items.model';
...
export class SalesComponent implements OnInit {
  ...
  async loadData() {
    ...
    this.salesService.getSalesById({ id: 0, date: this.date }).subscribe(data => {
      this.itemsData = data;
  ...
  async itemReports() {
    ...
    console.log(this.sId);
    this.salesService.getSalesById({ id: this.sId, date: this.date }).subscribe(data => {
      this.itemsData = data;
      this.Data = this.itemsData.salesData;
      console.log(this.Data);
      this.isLoading = false;
  ...
  expanded(data:any){
    ...
    this.salesService.getNewSalesItemBySaleId(data.id).subscribe((data) => {
